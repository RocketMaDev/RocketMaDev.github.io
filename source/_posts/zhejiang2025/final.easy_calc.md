---
title: 第八届浙江省大学生网络与信息安全竞赛 决赛 - easy calc
date: 2026/03/20 16:24:00
updated: 2026/03/27 16:27:00
tags:
    - buffer nearby-flow
excerpt: 利用计算器对数字栈自减检查缺陷造成栈大小为 -1 实现溢出，借助 `(` 反向构造多次压栈伪造 ROP 链，先 `puts` 泄露 libc 再调用 `system` 拿 shell。
---
