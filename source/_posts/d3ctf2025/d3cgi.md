...
{% callout green fa-vial-circle-check %}
...
{% callout yellow fa-face-grin-beam-sweat %}
...
1. [FastCGI.com fcgi2 Development Kit](https://github.com/FastCGI-Archives/fcgi2)
