---
title: 第七届浙江省大学生网络与信息安全竞赛 初赛 - shellcode
date: 2025/02/20 22:40:00
updated: 2026/03/27 15:59:00
tags:
    - noob
excerpt: 利用 `call` 泄露 pie_base 并借 `main` 已设置 rdx/rsi/rdi 绕过 10 字节与 syscall 过滤限制，构造二段 shellcode 复用 read 写入完整 execve 获取 shell。
---
...
![stack](/assets/zhejiang2024/stack.png)
