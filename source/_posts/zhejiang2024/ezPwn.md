---
title: 第七届浙江省大学生网络与信息安全竞赛 决赛 - ezPwn
date: 2025/02/20 22:50:00
updated: 2026/03/27 15:59:00
tags:
    - IO arb write
excerpt: 利用 `edit` 未校验 idx 越界访问 `datas[-20]` 篡改 `stdout` 结构体，伪造 `_flags = 0xfbad1800` 与 `_IO_write_base/_ptr` 指向 bss 中已读入的 flag，触发流刷新泄露 flag。
---
...
<img src="/assets/zhejiang2024/sandbox.png" width="60%">
