---
title: 第七届浙江省大学生网络与信息安全竞赛 初赛 - apple
date: 2025/02/20 22:41:00
updated: 2026/03/27 15:58:00
tags:
    - House of Apple 2
thumbnail: /assets/zhejiang2024/bss.png
excerpt: 利用 unsorted bin 泄露 libc_base，借助 `idx < 0` 覆盖 `stdout` 并结合 House of Apple 2 构造 FSOP，退出时调用 `system("sh;")` 拿shell。
---
...
![bss](/assets/zhejiang2024/bss.png)
