---
title: 第七届浙江省大学生网络与信息安全竞赛 决赛 - reverse_stack
date: 2025/02/20 22:52:00
updated: 2026/03/27 15:59:00
tags:
    - exit hook
excerpt: 利用正向增长栈泄露 libc_base 和 mmap_base，覆盖 `fs:[0x30]` 绕过 `PTR_MANGLE`，伪造 `__call_tls_dtors` 的 destructor 为 mangled `system("/bin/sh")` 实现退出时 getshell。
---
