---
title: 第七届浙江省大学生网络与信息安全竞赛 决赛 - printFFF
date: 2025/02/20 22:51:00
updated: 2026/03/27 15:59:00
tags:
    - fmt-string
excerpt: 利用格式化字符串漏洞通过 `%hn` 将 `0x5000` 写入 `exit@GOT` 劫持到 bss 上的 21 字节 shellcode，从而 get shell。
---
...
![flag](/assets/zhejiang2024/printFFF.png)
{% endnote %}
