---
title: 强网杯 S9 2025 初赛 - file-system
date: 2025/10/28 01:02:00
updated: 2025/10/28 01:02:00
tags:
    - IO hijack
excerpt: 利用负索引绕过检查泄露 `__dso_handle` 与栈地址，通过修改 `stdout` 获取无限编辑机会，最终覆盖返回地址执行 shellcode。
thumbnail: /assets/qwb2025/verify_chance.png
---
...
{% callout green fa-bolt %}
建议先看[bph writeup](/2025/10/25/bph/)再来看这篇writeup，知识点是相通的；
...
<img src="/assets/qwb2025/show_file.png" width="70%">
...
<img src="/assets/qwb2025/leak_bss.png" width="70%">

因此借助`__dso_handle`，我们可以泄露程序基地址以及栈地址。

{% callout blue fa-compass-drafting %}
...
<img src="/assets/qwb2025/verify_chance.png" width="80%">
...
<img src="/assets/qwb2025/note_rbp-8.png" width="90%">
