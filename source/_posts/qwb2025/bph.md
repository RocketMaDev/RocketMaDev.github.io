---
title: 强网杯S9 2025 初赛 - bph
date: 2025/10/26 00:50:00
updated: 2025/10/26 01:01:00
tags:
    - House of Apple 2
    - IO arb read
    - tricks
    - stack pivot
thumbnail: /assets/qwb2025/fgets_io.png
excerpt: 利用部分写和任意写0泄露libc并拓展为任意写，构造House of Apple 2链，通过`mov rsp, rdx; ret`实现栈迁移绕过seccomp执行ROP打印flag。
---
...
<img src="/assets/qwb2025/bph_rules.png" width="60%">
...
<img src="/assets/qwb2025/leak_info.png" width="50%">

<img src="/assets/qwb2025/create_0.png" width="40%">

检查我们首次输入内容时可以泄露的内容，有堆、栈、程序基址、libc和libseccomp，
然而只能取其一，那我们选择泄露`free`的地址来获取libc基址。

<img src="/assets/qwb2025/avail_info.png" width="90%">
...
![io stream](/assets/qwb2025/fgets_io.png)
...
<img src="/assets/qwb2025/gadgets_found.png" width="70%">
...
![rdx](/assets/qwb2025/apple2_rdx.png)
