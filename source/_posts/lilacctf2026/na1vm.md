---
title: LilacCTF 2026 - na1vm
date: 2026/01/28 23:33:00
updated: 2026/01/29 00:47:00
excerpt: 实时信号指令溢出改 `qtail`/`stack` 泄露 PIE 与 libc，劫持 `_IO_list_all` 做 FSOP 栈迁移加 ROP 执行 shellcode 输出 flag。
tags:
    - signal
    - House of Apple 2
    - stack pivot
thumbnail: /assets/lilacctf2026/memory-layout.png
---
...
![memory-layout](/assets/lilacctf2026/memory-layout.png)
