---
title: LilacCTF 2026 - Gate-Way
date: 2026/01/27 23:08:00
updated: 2026/01/29 00:47:00
excerpt: Hexagon 架构下利用栈溢出做栈迁移并用 r16–r19 控制 `trap0` ROP 构造 `execve("/bin/sh", NULL, NULL)` 拿到 shell。
tags:
    - qemu-user
    - ROP
    - hexagon
thumbnail: /assets/lilacctf2026/lldb.png
---
...
![lldb](/assets/lilacctf2026/lldb.png)
...
<img src="/assets/lilacctf2026/qemu-page.png" width="35%">
