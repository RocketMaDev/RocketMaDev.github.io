---
title: LilacCTF 2026 - Chuantongxiangyan
date: 2026/01/26 22:33:00
updated: 2026/01/29 00:47:00
excerpt: 利用 `snprintf` 格式化串多次伪造 `argv` 指针实现任意地址写，篡改 GOT 与返回地址触发 one_gadget。
tags:
    - fmt-string
    - got-hijack
thumbnail: /assets/lilacctf2026/fmt-control.png
---
...
![valist](/assets/lilacctf2026/valist.png)
...
![argidx](/assets/lilacctf2026/argidx.png)
...
<img src="/assets/lilacctf2026/fmt-control.png" width="80%">
