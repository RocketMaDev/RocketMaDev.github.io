...
> 或者由 *dbgbgtf* 的[sixbytes和usersys](https://dbgtf.org/dasctf)。
...
<img src="/assets/dasx0rays2024/sandbox.png" height="70%" width="70%">
...
{% callout blue fa-circle-info ::angry-FSROP %}
...
![fake FILE](/assets/dasx0rays2024/fakeFile.png)

根据写出的fakeFile，我最终指定后门可以`PTR_MANGLE`一个堆块+0x80处的指针，
别忘了前面还有0x10的时间字符串！最终也是成功在本地起了bash。

{% callout green fa-lightbulb ::控制`wide_data` %}
...
{% callout purple fa-clock-rotate-left %}
...
{% callout orange fa-book-bookmark ::exit_hook的原理 %}
